...
tags:
  ...
  - DecorView
  - 安卓12
permalink: /blog/2022/exagear-keyboard/index/
---
:::tip
- 若只想知道怎么解决，请从[解决方案-动手操作](#将此功能添加到apk)开始看
...
4. 2026.06：找到一种无需延迟固定时间，更迅速的方法：从 view 获取 ViewTreeObserver, 添加一次性的 OnWindowFocusChange 监听，变化时通过 view.post 在下一帧显示键盘。