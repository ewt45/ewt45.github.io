---
createTime: '2023/05/12 09:50:04'
title: 在termux中安装的proot-distro，如何在第三方文件管理器中查看其文件目录
categories:
  - 技术
tags:
  - termux
  - proot
permalink: /blog/2023/termux-check-proot-dir/index/
---
26.07.25 注：pd 5.0 大幅改动。路径从 `installed-rootfs` 变为 `containers`
